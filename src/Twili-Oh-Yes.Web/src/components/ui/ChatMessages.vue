<template>
  <div
    class="chat-message"
    :class="{ outgoing: isOutgoing(message), incoming: isIncoming(message) }"
  >
...
export default defineComponent({
  ...
  methods: {
    ...
    isIncoming(message: Message): boolean {
      // Undefined is an incoming message because, in my first incoming messages there were no Direction 'property' and
      // i didnt know it cost 💸money💸 so i created just fake incoming message in db
      return (
        message.Direction === undefined || message.Direction === "incoming"
      );
    },
  },
});
